window.config = {
  ...
  servers: {
    dicomWeb: [
      {
        name: 'DCM4CHEE',
        wadoUriRoot: 'https://test2-dcm.eclarityhealth.com/dcm4chee-arc/aets/DCM4CHEE/wado',
        qidoRoot: 'https://test2-dcm.eclarityhealth.com/dcm4chee-arc/aets/DCM4CHEE/rs',
        wadoRoot: 'https://test2-dcm.eclarityhealth.com/dcm4chee-arc/aets/DCM4CHEE/rs',
